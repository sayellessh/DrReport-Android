 ...
 */
public class RecentDAO extends CoreDAO {

    private static final LogTracer LOG_TRACER = LogTracer.instance(RecentDAO.class);

    public static final String TABLE_NAME = "RECENT_DOCTORS";
    public enum Column {
    ...
    public static StringBuilder getCreateQuety() {
        ...
        sb.append(addNewColumn(Column.Phone_Number, ColumnTypes.TEXT));
    ...
    public List<Doctor> getAll() {
        ...
        try {
            ...
            res = db.rawQuery("SELECT * FROM " + TABLE_NAME + " LIMIT 10", null);
            res.moveToFirst();
            Doctor item = null;
