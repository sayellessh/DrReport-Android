 ...
 * </pre>
 */
public class ClearableEditText extends DefaultEditText implements OnTouchListener, OnFocusChangeListener, TextWatcherAdapter.TextWatcherListener {
    ...
    private void init() {
        ...
        if (xD == null) {
            xD = ContextCompat.getDrawable(getContext(), net.swaas.drinfo.R.drawable.ic_clear_black_18dp);
        }
